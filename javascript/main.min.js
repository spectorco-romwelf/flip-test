...
"TelephoneNumberButton"==d.getClassName()&&global.PcTelephoneNumberFrame.setDirection(TextBubble.LEFT),d.addTo(this.extended),d.hint=!1}b<this.buttonCount&&(this.btnMore.addTo(this.container.body),this.btnMore.setPosition(a,this.buttonTop));this.addPageButtons()},addPageButtons:function(){function a(k){k.addTo(c);k.setPosition(d,f);d+=e}function b(){d+=l;g.css({left:d+"px",top:h+"px",width:m+"px",display:"block"});g.find("input").css({width:m+"px"});d+=m+4;d+=l}var c=this.pageContainer.body,d=Math.floor((this.pageContainer.width-
(this.edtNumber.width+2*this.edtNumber.space+this.pageButtonCount*this.buttonWidth))/2),e=this.buttonWidth,f=this.edtNumber.top,g=this.edtNumber.body,h=this.edtNumber.top,l=this.edtNumber.space,m=this.edtNumber.width;rightToLeft?(bookConfig.enablePageBack&&a(this.btnForward),a(this.btnLast),a(this.btnNext),b(),a(this.btnPrevious),a(this.btnFirst),bookConfig.enablePageBack&&a(this.btnBackward)):(bookConfig.enablePageBack&&a(this.btnBackward),a(this.btnFirst),a(this.btnPrevious),b(),a(this.btnNext),
a(this.btnLast),bookConfig.enablePageBack&&a(this.btnForward));return d}}).extend("ButtonQueue");Class("MobileButtonQueue",{sort:function(a,b){a=this.edtNumber.width+2*this.edtNumber.space+4*this.buttonWidth;this.addPageButtons(a,(this.container.width-a)/2);this.buttons.each(function(c){c.addTo(this.extended)}.bind(this))}}).extend("ButtonQueue");Class("PCToolbar",{initBar:function(){this.topBar=$("<div class='fbTopBar' id='fbTopBar'></div>");this.bottomBar=$("<div class='fbToolBar' id='fbToolBar'></div>");this.logoBar=$("<div id='logoBar' class='logoBar'></div>");this.buttonTopBar=$("<div class='top right buttonTopBar'></div>");this.buttonBar=$("<div class='bottom left buttonBar'></div>");this.edtPageNumber=$("<div class='pageNumber' id='tfPageIndex'><label><input aria-label='"+getLanguage("ariaPageNumber","page number")+"' aria-labelledby='currentPageIndex' type='text' id='currentPageIndexTextField' autocomplete='off' size='13'/></label></div>");
